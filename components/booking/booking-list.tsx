...
export function BookingList({ bookings, loading, onViewDetails }: BookingListProps) {
    ...
    const filteredBookings = bookings.filter(b => {
        ...
        // Academy filter logic could be extended
        const matchesAcademy = academyFilter === "all" || b.academyId === academyFilter; // Simple check
        ...
        <div className="bg-white rounded-[24px] shadow-[0px_4px_15px_0px_rgba(131,131,131,0.64)] p-6 md:p-8 ">
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    ...
                    <Select value={academyFilter} onValueChange={setAcademyFilter}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="ac1">Vapi Academy</SelectItem>
                        </SelectContent>
                    </Select>
                            ...
                            paginatedBookings.map((booking) => (
                                <TableRow key={booking.id} className="border-b border-[#EAECF0] hover:bg-slate-50 text-nowrap">
                                    <TableCell className="py-4 text-[#344054] font-medium text-sm">
                                        <button onClick={() => onViewDetails(booking.id)} className="text-[#6941C6] hover:underline cursor-pointer">
            ...
            <div className="md:hidden space-y-4">
                ...
                {loading ? (
                    ...
                    paginatedBookings.map((booking) => (
                        <div key={booking.id} onClick={() => onViewDetails(booking.id)} className="bg-white border border-[#e5e7eb] rounded-[14px] p-4 shadow-sm active:scale-[0.98] transition-transform cursor-pointer">
